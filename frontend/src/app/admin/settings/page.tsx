            ...
            <div>
              ...
              />
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-medium text-gray-900">PSE (Colombia)</h4>
                  
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      id="pseEnabled"
                      checked={paymentSettings.pseEnabled}
                      onChange={(e) => setPaymentSettings({...paymentSettings, pseEnabled: e.target.checked})}
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="pseEnabled" className="ml-2 block text-sm text-gray-900">
                      Habilitar PSE
                    </label>
                  </div>

                  {paymentSettings.pseEnabled && (
                    <>
                      <div>
                        <label htmlFor="pseIntegrationKey" className="block text-sm font-medium text-gray-700">
                          Integration Key
                        </label>
                        <input
                          type="password"
                          id="pseIntegrationKey"
                          value={paymentSettings.pseIntegrationKey}
                          onChange={(e) => setPaymentSettings({...paymentSettings, pseIntegrationKey: e.target.value})}
                          className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Tu clave de integración de EBANX"
                        />
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          id="pseSandbox"
                          checked={paymentSettings.pseSandbox}
                          onChange={(e) => setPaymentSettings({...paymentSettings, pseSandbox: e.target.checked})}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <label htmlFor="pseSandbox" className="ml-2 block text-sm text-gray-900">
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-blue-700">
                              <p>
                                PSE es el sistema de pagos en línea más popular en Colombia. 
                                Permite a los clientes pagar directamente desde su cuenta bancaria.
                              </p>
                              <ul className="list-disc list-inside mt-2">
                                <li>Soporta todos los bancos principales de Colombia</li>
                                <li>Pagos en tiempo real</li>
                                <li>Sin riesgo de contracargos</li>
                                <li>Integración con EBANX</li>
                              </ul>
                            </div>
                          </div>
                        </div>
